          ...
          <div className='imagenFondo'>
            <div className='info-producto'>
                <div>
                    ...
                    <div className='desc'><a href={document} target="_blank" rel='noreferrer' className='link'><img src={download} className='download' alt=''></img><div>Descargar archivo</div></a></div>
                </div>
            </div>
          </div>
      </div>
